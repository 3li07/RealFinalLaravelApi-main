...
class CandidatsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($vs->fails()){
            ...
            $candidat->update([
                ...
                'selectedDiplome'=> 'http://localhost:8000/storage/'.$diplome,
                'selectedReleveDeNoteBacc'=> 'http://localhost:8000/storage/'.$rlvBacc,
                'selectedReleveDeNoteSeconde'=> 'http://localhost:8000/storage/'.$rlvSeconde,
                'selectedReleveDeNotePremiere'=> 'http://localhost:8000/storage/'.$rlvPremiere,
                'selectedReleveDeNoteTerminale'=> 'http://localhost:8000/storage/'.$rlvTerminale,
                'certificatDeResidance'=> 'http://localhost:8000/storage/'.$certificatDeResidence,
                'photo'=> 'http://localhost:8000/storage/'.$selectedPhoto,
                'selectedCINorCIS'=> 'http://localhost:8000/storage/'.$selectedCINorCIS,
                'cv'=> 'http://localhost:8000/storage/'.$cv,
                'bordereauEsti'=> 'http://localhost:8000/storage/'.$bordereauEsti,
            ]);
    ...
    public function show(Candidat $candidat)
    {
        return [
            ...
            "selectedDiplome" =>$candidat->selectedDiplome,
